...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden pt-12 pb-16 md:pt-20 md:pb-24 lg:pt-28">
      ...
      <div className="pointer-events-none absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-100 bg-emerald-500/10 blur-[120px] rounded-full" />
      <div className="pointer-events-none absolute top-1/3 right-10 w-75 h-75 bg-teal-500/10 blur-[100px] rounded-full" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="inline-flex items-center gap-2 mb-6">
          ...
          >
            ...
            <span>
              The #1 SaaS Operating System for Football & Sports Turfs
            </span>
          </Badge>
        </div>
        ...
        <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          Turvo replaces messy WhatsApp chats and paper logs with automated slot
          scheduling, instant email & SMS notifications, unlimited member
          tracking, and secure deposit collections.
        </p>
        ...
        <div className="mt-8 flex flex-wrap justify-center items-center gap-4 text-xs sm:text-sm text-muted-foreground">
          ...
          <span className="inline-flex items-center gap-1.5">
            <CheckCircle2 className="h-4 w-4 text-emerald-500" /> Unlimited
            Members Included
          </span>
          <span className="inline-flex items-center gap-1.5">
            <CheckCircle2 className="h-4 w-4 text-emerald-500" /> Zero Credit
            Card Required
          </span>
        </div>
